...
public class LayerMainBlade<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    @Override
    public void render(@NotNull PoseStack matrixStack, @NotNull MultiBufferSource bufferIn, int lightIn,
    ...
    public void setUserPose(PoseStack matrixStack, T entity, float partialTicks) {
        if (!UserPoseOverrider.UsePoseOverrider
                ...
                && entity instanceof IAnimatedPlayer animatedPlayerEntity) {

            var animationPlayer = animatedPlayerEntity.playerAnimator_getAnimation();
